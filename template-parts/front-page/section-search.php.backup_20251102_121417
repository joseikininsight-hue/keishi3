    ...
    <div class="recommend-wrapper">
        <header class="section-header">
            <div class="header-left">
                <h2 id="recommend-title" class="section-title" itemprop="name">
                    <i class="fas fa-user-circle" aria-hidden="true"></i>
                    あなたの閲覧履歴からおすすめ
                </h2>
                <p class="section-desc" itemprop="description">
                    希望条件を設定しておくと、あなたに合った補助金が見つかります
                </p>
            </div>
            <a href="<?php echo esc_url(home_url('/grants/')); ?>" 
               class="view-all"
               aria-label="おすすめ補助金の一覧を見る"
               title="おすすめ補助金の一覧ページへ">
                一覧へ <i class="fas fa-chevron-right" aria-hidden="true"></i>
            </a>
        </header>
        ...
        <div class="grants-grid" role="list">
            ...
            ?>
                <article class="grant-card" 
                    ...
                    <?php if ($is_featured) : ?>
                    <span class="badge badge-featured" aria-label="注目の補助金">注目</span>
                    <?php endif; ?>
                    ...
                    <a href="<?php echo esc_url($permalink); ?>" 
                       ...
                       title="<?php echo esc_attr($grant->post_title); ?>の詳細ページへ">
                        ...
                        <header class="card-header">
                            <div class="card-org" 
                                ...
                                <i class="fas fa-building" aria-hidden="true"></i>
                                <span itemprop="name"><?php echo esc_html($organization ?: '公的機関'); ?></span>
                            </div>
                        ...
                        <div class="card-tags">
                            ...
                            <span class="tag" itemprop="category">
                            ...
                            <span class="tag tag-location" itemprop="areaServed">
                                <i class="fas fa-map-marker-alt" aria-hidden="true"></i>
                        ...
                        <footer class="card-footer">
                            ...
                            <div class="footer-item" 
                                ...
                                <span>最大: <span itemprop="price"><?php echo esc_html($max_amount); ?></span></span>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="footer-item deadline">
                                ...
                                <span>締切: 
                                    <?php if ($deadline_iso) : ?>
                                    <time datetime="<?php echo esc_attr($deadline_iso); ?>" 
            ...
            ?>
                <p class="no-data" role="status">現在、おすすめの補助金はありません。</p>
            <?php endif; ?>
        </div>
    </div>
</section>
...
<section class="new-grants-section" 
         aria-labelledby="new-grants-title"
         itemscope 
         itemtype="https://schema.org/ItemList">
    <div class="new-grants-wrapper">
        <header class="section-header">
            <div class="header-left">
                <h2 id="new-grants-title" class="section-title" itemprop="name">
                    <i class="fas fa-clock" aria-hidden="true"></i>
                    新着補助金
                    <span class="count-badge" 
                          aria-label="<?php echo count($new_grants); ?>件">
                        <?php echo count($new_grants); ?>
                    </span>
                </h2>
        ...
        <div class="grants-grid" role="list">
            ...
            ?>
                <article class="grant-card" 
                    ...
                    <meta itemprop="datePublished" 
                          content="<?php echo get_the_date('Y-m-d', $grant->ID); ?>">
                    
                    <?php if ($is_new) : ?>
                    <span class="badge badge-new" aria-label="新着補助金">NEW</span>
                    <?php endif; ?>
            ...
            ?>
                <p class="no-data" role="status">現在、新着補助金はありません。</p>
            <?php endif; ?>
        </div>
    </div>
</section>
