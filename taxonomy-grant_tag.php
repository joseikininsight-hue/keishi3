<?php
/**
 * Tag Archive Template for Grant Post Type - プルダウン式完全版 v17.0
 * 
 * タグアーカイブ - プルダウン式フィルター・単体表示ベース・AI機能搭載
 * archive-grant.phpと同じデザインと機能を提供
 * 
...
// タイトル・説明文
if ($is_tag_archive && $current_tag) {
    $archive_title = '#' . $current_tag->name . ' の助成金・補助金';
    $archive_description = $current_tag->description ?: $current_tag->name . 'に関連する助成金・補助金の情報をまとめています。';
...
$breadcrumbs = [
    ...
    ['name' => 'タグ一覧', 'url' => home_url('/grant_tag/')],
        ...
        <div class="container">
            <div class="hero-content-wrapper">
                ...
                <h1 class="category-main-title" itemprop="headline">
                    ...
                    <span class="category-name-highlight"><?php echo esc_html($tag_name); ?></span>
                ...
                <div class="category-meta-info">
                    <div class="meta-item">
                        ...
                        <strong><?php echo number_format($tag_count); ?></strong>件の助成金
                    </div>
                    <div class="meta-item">
                        <svg class="meta-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
...
(function() {
    ...
    const state = {
        ...
        filters: {
            ...
            difficulty: '',
            sort: 'date_desc',
            tag: '<?php echo esc_js($tag_slug); ?>' // タグアーカイブの場合、現在のタグを設定
        },
        isLoading: false,
        tempCategories: [],
        tempPrefectures: [],
