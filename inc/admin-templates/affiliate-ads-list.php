                    ...
                    <tr data-ad-id="<?php echo esc_attr($ad->id); ?>">
                        ...
                        <td>
                            ...
                            $position_labels = array(
                                ...
                                // アーカイブページ
                                'archive_column_sidebar_pr' => 'コラムアーカイブ:PR',
                                'archive_column_sidebar_top' => 'コラムアーカイブ:SB上',
                                'archive_column_sidebar_bottom' => 'コラムアーカイブ:SB下',
                                'archive_grant_content_top' => '補助金アーカイブ:上',
                                'archive_grant_content_bottom' => '補助金アーカイブ:下',
                                // フロントページ
        ...
        <form id="ji-ad-form">
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="target_pages" id="target_pages" class="regular-text">
                        <p class="description">空白の場合、すべてのページに表示されます。カンマ区切りでページタイプを指定できます（例: single-grant, single-column）</p>
                    </td>
                </tr>
...
jQuery(document).ready(function($) {
    ...
    $('.ji-edit-ad').on('click', function(e) {
        ...
        // フォームに既存データを入力（実装省略 - 実際はAJAXでデータ取得）
